...
```console
npm install @mpaperno/skia-canvas
```

This will download a pre-compiled library from the project’s most recent [release](https://github.com/mpaperno/skia-canvas/releases).
...
| [isPointInPath()][isPointInPath()]            | [fillText()][fillText()] ⧸[⚡][drawText]     | [createLinearGradient()][createLinearGradient()]  | [**lineDashOffset**][lineDashOffset]   | [setTransform()][setTransform()]                 | [bezierCurveTo()][bezierCurveTo()]       | [**letterSpacing**][letterSpacing]                         | [getImageData()][getImageData()]                   | [**shadowBlur**][shadowBlur]                             |
| [isPointInStroke()][isPointInStroke()]        | [strokeText()][strokeText()] ⧸[⚡][drawText] | [createRadialGradient()][createRadialGradient()]  | [**lineJoin**][lineJoin]               | [resetTransform()][resetTransform()]             | [conicCurveTo() ⚡][conicCurveTo]         | [**wordSpacing**][wordSpacing]                             | [putImageData()][putImageData()]                   | [**shadowColor**][shadowColor]                           |
| [save()][save()]                              | [fill()][fill()]                            | [createPattern()][createPattern()]                | [**lineWidth**][lineWidth]             | [transform()][transform()] ⧸[⚡][transform]       | [quadraticCurveTo()][quadraticCurveTo()] | [**textAlign**][textAlign]                                 | [drawCanvas() ⚡](#drawcanvascanvas-x-y-)           | [**shadowOffsetX**][shadowOffsetX]                       |
| [restore()][restore()]                        | [stroke()][stroke()]                        | [createTexture() ⚡][createTexture()]              | [**miterLimit**][miterLimit]           | [translate()][translate()]                       | [arc()][arc()]                           | [**textBaseline**][textBaseline]                           | [drawImage()][drawImage()]                         | [**shadowOffsetY**][shadowOffsetY]                       |
| [reset()][reset()]                            |                                             |                                                   | [getLineDash()][getLineDash()]         | [rotate()][rotate()]                             | [ellipse()][ellipse()]                   | [**textWrap** ⚡](#textwrap)                                |                                                    |                                                          |
| [clip()][clip()]                              |                                             |                                                   | [setLineDash()][setLineDash()]         | [scale()][scale()]                               | [rect()][rect()]                         | [measureText()][measureText()] ⧸[⚡](#measuretextstr-width) |                                                    |                                                          |
|                                               |                                             |                                                   |                                        |                                                  | [roundRect()][roundRect()]               | [outlineText() ⚡][outlineText()]                           |                                                    |                                                          |
