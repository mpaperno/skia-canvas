...
tests['drawImage with negative source rect origin'] = function (ctx, done) {
  var img1 = new Image()
  var img2 = new Image()
  img1.onload = function () {
    img2.onload = function () {
...
tests['shadow scale & skew'] = function (ctx) {
  ctx.translate(-20, 0)
...
tests['shadowBlur rotate & scale'] = function (ctx) {
  ctx.shadowColor = '#c00'
  ctx.shadowBlur = 5
  ctx.shadowOffsetX = 10
  ctx.shadowOffsetY = 10
  drawPinwheel(ctx, {scl: 1.5, offset: 20});
}

function drawScaledBoxes(ctx, {sz = 200, sp = 50, x = sp, y = sp, scl = 0.25} = {}) {
  ctx.fillStyle = 'black';
  ctx.shadowColor = '#c00';
  for (let i = 1; i <= 9; ++i) {
    ctx.scale(scl, scl);
...
tests['shadowBlur varying scale'] = function (ctx) {
  ctx.shadowBlur = 6;
  ctx.shadowOffsetX = 5;
  ctx.shadowOffsetY = 5;
  drawScaledBoxes(ctx);
...
tests['shadowBlur skew & varying scale'] = function (ctx) {
  ctx.shadowBlur = 6;
  ctx.shadowOffsetX = -5;
  ctx.shadowOffsetY = -8;
  // ctx.translate(-20, 0);
