...
class Canvas extends RustClass{
  ...
  saveAs(filename, opts={}){
    ...
    let {format, quality, pages, padding, pattern, density, outline, matte, bounds} =
      io.options(this.pages, this.size, {filename, ...opts})
    return this.ƒ("save", pages.map(core), pattern, padding, format, quality, density, outline, matte, bounds)
  }
  ...
  saveAsSync(filename, opts={}){
    ...
    let {format, quality, pages, padding, pattern, density, outline, matte, bounds} =
      io.options(this.pages, this.size, {filename, ...opts})
    this.ƒ("saveSync", pages.map(core), pattern, padding, format, quality, density, outline, matte, bounds)
  }
  ...
  toBuffer(extension="png", opts={}){
    ...
    opts = typeof opts=='number' ? {quality:opts} : opts
    let {format, quality, pages, density, outline, matte, bounds} =
      io.options(this.pages, this.size, {extension, ...opts})
    return this.ƒ("toBuffer", pages.map(core), format, quality, density, outline, matte, bounds)
  }
  ...
  toBufferSync(extension="png", opts={}){
    ...
    let {format, quality, pages, density, outline, matte, bounds} =
      io.options(this.pages, this.size, {extension, ...opts})
    return this.ƒ("toBufferSync", pages.map(core), format, quality, density, outline, matte, bounds)
  }
