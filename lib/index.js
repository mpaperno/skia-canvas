...
class CanvasRenderingContext2D extends RustClass{
  ...
  static ENUM_PROPS = [
    "canvas", "currentTransform", "direction", "fillStyle", "filter", "font", "fontStretch", "fontVariant",
    "globalAlpha", "globalCompositeOperation", "imageSmoothingEnabled", "imageSmoothingQuality",
    "letterSpacing", "lineCap", "lineDashFit", "lineDashMarker", "lineDashOffset", "lineJoin", "lineWidth", "miterLimit",
    "shadowBlur", "shadowColor", "shadowOffsetX", "shadowOffsetY", "strokeStyle",
    "textAlign", "textBaseline", "textTracking", "textWrap", "wordSpacing",
  ]
